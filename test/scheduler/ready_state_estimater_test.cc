...
TEST(READY_STATE_ESTIMATOR, ESTIMATE_READ) {
    ...
    ASSERT_EQ(0, estimator.estimate_number_of_ready_ios(5));
    ASSERT_EQ(1, estimator.estimate_number_of_ready_ios(10));
    ASSERT_EQ(1, estimator.estimate_number_of_ready_ios(15));
    estimator.remove_read_io(0);
    ASSERT_EQ(0, estimator.estimate_number_of_ready_ios(15));
}
...
TEST(READY_STATE_ESTIMATOR, ESTIMATE_MIXED) {
    ...
    ASSERT_EQ(2, estimator.estimate_number_of_ready_ios(15));
    ASSERT_EQ(3, estimator.estimate_number_of_ready_ios(25));

    ASSERT_EQ(0, estimator.estimate_number_of_ready_writes(15));
    ASSERT_EQ(1, estimator.estimate_number_of_ready_writes(25));

    estimator.remove_write_io(2);
    ASSERT_EQ(2, estimator.estimate_number_of_ready_ios(25));
    ASSERT_EQ(0, estimator.estimate_number_of_ready_writes(25));
